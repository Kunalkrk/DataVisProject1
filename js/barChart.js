class BarChart {
    ...
    initVis() {
        ...
        bars.append("rect")
            ...
            .on("mouseover", function(event, d) {return tip.text(vis.xLabel + " " + d.key + ", " + vis.yLabel + " " + d.value).style("visibility", "visible").style("top", (event.pageY - 20) + 'px' ).style("left", event.pageX - 50 + 'px')})
